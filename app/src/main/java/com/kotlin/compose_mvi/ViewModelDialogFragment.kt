...
abstract class ViewModelDialogFragment<VD : ViewDataBinding, VM : BaseViewModel>(
    @LayoutRes
    ...
    @StyleRes
    protected open val themeId: Int = R.style.Dialog_Popup

    protected abstract val viewModel: VM

    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        setStyle(STYLE_NO_FRAME, if (themeId != -1) themeId else theme)
